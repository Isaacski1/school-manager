...
import { ArrowRight, CheckCircle2, Loader2, Calendar, Phone, School, Users, X } from "lucide-react";
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <p style={{ fontSize: 12, fontWeight: 700, textTransform: "uppercase", color: "#93C5FD", letterSpacing: "0.1em", margin: "0 0 12px 0" }}>Self-Service Learning</p>
              <h2 style={{ fontSize: "clamp(26px, 4vw, 36px)", fontWeight: 800, color: "white", margin: "0 0 16px 0" }}>Video Tutorials & Guides</h2>
              <p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", maxWidth: 600, margin: "0 auto" }}>Can't wait for a demo? Explore our quick-start video guides to see how each section of the platform works.</p>
            </motion.div>
          </div>
